...
prefix=$1
version=$2
distdir=${prefix}/usr/local/madlib-adb6
...
ln -s /usr/local/madlib-adb6/Versions/${version} ${distdir}/Current
ln -s /usr/local/madlib-adb6/Versions/${version}/bin ${distdir}/bin
ln -s /usr/local/madlib-adb6/Versions/${version}/doc ${distdir}/doc
