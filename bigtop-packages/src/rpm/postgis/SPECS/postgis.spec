...
%define         postgis_dir %{_builddir}/%{name}-%{postgis_version}/postgis/build/postgis-%{postgis_version}
...
Release:        %{postgis_release}
Group:          Development/Tools
AutoReq:        no
AutoProv:       no
Provides:       postgis = %{postgis_version}
Obsoletes:      postgis
%if %{_vendor} == "alt"
...
Source0:        %{name}-%{postgis_version}.tar.gz
...
%prep
%setup -q -n %{name}-%{postgis_version}
